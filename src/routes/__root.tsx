...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dorah Seroto — Software Developer" },
      {
        name: "description",
        content: "Portfolio of Dorah Motsatsi Seroto, software developer (Python, JavaScript, React).",
      },
      { name: "author", content: "Dorah Motsatsi Seroto" },
      { property: "og:title", content: "Dorah Seroto — Software Developer" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,400;9..144,600&family=Outfit:wght@300;400;500&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
